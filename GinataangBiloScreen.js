...
import imgparsley from './ginataang-bilo-bilo.png';
import {ScrollView} from 'react-native-gesture-handler';
import Icon from 'react-native-vector-icons/MaterialIcons';

export default class GinataangBiloScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    return (
      ...
      <Text style={{fontSize: 30, fontWeight: 'bold', fontFamily:'Century Gothic', color:'white'}}>Ginataang Bilo-Bilo</Text>
    </View>
